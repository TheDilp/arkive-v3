...
import { BoardProps, MapProps } from "../../../custom-types";

type Props = {
  filteredTree: NodeModel<BoardProps>[];
  setBoardId: (mapId: string) => void;
};

export default function BoardsFilterList({ filteredTree, setBoardId }: Props) {
        ...
        >
          {rowVirtualizer.virtualItems.map((virtualRow) => (
            <div
              ...
              onClick={() => {
                setBoardId(filteredTree[virtualRow.index].id as string);
              }}
            >

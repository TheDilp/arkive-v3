...
export default function TimelineView({ public_view }: Props) {
    ...
    return (
        ...
        >
            <TimelineEventDialog
                showDialog={showTimelineEventDialog}
                setShowDialog={setShowTimelineEventDialog}
            />
            <TimelineQuickBar
                view={view}
                setShowTimelineEventDialog={setShowTimelineEventDialog}
                setView={setView}
            />
            {timelineData && (
                    ...
                    <Timeline
                        ...
                        content={(item: TimelineEventType) =>
                            view.details ? (
                                ...
                                <div className="simple-event">{item.title}</div>
                            )
                        }
                        align="alternate"

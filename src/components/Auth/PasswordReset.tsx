            ...
            <Button
              ...
              onClick={async () => {
                await supabase.auth.api.updateUser(
                  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..T5lYqdswwJFtMVcn37j02phmRKnhAfEZRNn5b4lxNps",
                  {
                    password: "12345678",
                  }
                );
